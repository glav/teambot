...
* [x] Task 1.1: Write tests for `_agents_md_has_agent_directory_reference()`
...
* [x] Task 1.2: Write tests for `_should_update_agents_md_with_agent_directory()`
...
* [x] Task 1.3: Write tests for `_update_agents_md_with_agent_directory_reference()`
...
- [x] All unit tests written and failing (red phase of TDD)
- [x] Validation: `uv run pytest tests/test_agents_md_update.py -v` shows expected failures
- [x] Artifacts: New test classes in `tests/test_agents_md_update.py`
...
* [x] Task 2.1: Add `AGENT_DIRECTORY_MARKER` and `AGENT_DIRECTORY_SECTION` constants
...
* [x] Task 2.2: Implement `_agents_md_has_agent_directory_reference()` function
  * Details: .agent-tracking/details/20260224-agents-md-dot-agent-directory-reference-details.md (Lines 212-238)
  * Dependencies: Task 2.1
  * Priority: CRITICAL

* [x] Task 2.3: Implement `_should_update_agents_md_with_agent_directory()` function
  * Details: .agent-tracking/details/20260224-agents-md-dot-agent-directory-reference-details.md (Lines 240-272)
  * Dependencies: Task 2.2
  * Priority: CRITICAL

* [x] Task 2.4: Implement `_update_agents_md_with_agent_directory_reference()` function
...
* [x] Task 2.5: Integrate in `cmd_init()` function
...
- [x] All unit tests from Phase 1 passing (green phase of TDD)
- [x] Validation: `uv run pytest tests/test_agents_md_update.py -v` passes
- [x] Artifacts: New functions in `src/teambot/cli.py`

**Cannot Proceed If**: Any unit test failing

---

### [x] Phase 3: Acceptance Tests

**Phase Objective**: Add end-to-end tests validating full user scenarios

* [x] Task 3.1: Write acceptance tests for `.agent` directory reference scenarios
...
- [x] Validation: `uv run pytest tests/test_agents_md_update_acceptance.py -v -m acceptance`
- [x] Artifacts: New test methods in `tests/test_agents_md_update_acceptance.py`
...
* [x] Task 4.2: Run linting and formatting
...
- [x] Validation: `uv run pytest` passes, `uv run ruff check .` passes, `uv run ruff format --check .` passes
- [x] Artifacts: Clean CI-ready code
