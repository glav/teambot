...
- [ ] Edge cases tested (multiple refs, hyphenated, duplicates)
...
- [ ] Waiting relationship shown (e.g., "@pm→@ba")
...
- [ ] Comparison table explains `$ref` vs `->` differences
...
* [ ] Task 9.2: Validate coverage targets
  ...
  * Success: Overall coverage ≥85%
  * Dependencies: Task 9.1

### Phase Gate: Phase 9 Complete When
- [ ] Full workflow test passes (BA → PM refs BA → Builder refs PM)
