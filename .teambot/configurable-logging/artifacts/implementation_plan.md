...
- [ ] Validation: `uv run pytest tests/test_config/test_loader.py -k logging -v` shows failing tests
- [ ] Artifacts: New test class `TestLoggingConfigValidation` in `test_loader.py`
...
- [ ] Phase 1 tests pass (Green phase of TDD)
- [ ] Validation: `uv run pytest tests/test_config/test_loader.py -k logging -v` passes
- [ ] Artifacts: `_validate_logging()` method, updated `_apply_defaults()`
...
- [ ] Validation: `uv run pytest tests/test_config/test_logging_config.py -v` shows failing tests
- [ ] Artifacts: New test file `tests/test_config/test_logging_config.py`
...
- [ ] Phase 3 tests pass (Green phase)
- [ ] Validation: `uv run pytest tests/test_config/test_logging_config.py -v` passes
- [ ] Artifacts: `logging_config.py` with `is_interactive_mode()` and `setup_logging()`
...
- [ ] CLI flag recognized by parser
- [ ] Validation: `uv run teambot run --help` shows `--log-to-console` flag
- [ ] Artifacts: Updated `cli.py` with flag and mode-aware logging
...
- [ ] All tests pass: `uv run pytest --cov=src/teambot`
- [ ] Linting passes: `uv run ruff check .`
- [ ] Formatting passes: `uv run ruff format --check .`
- [ ] Coverage meets target (90%+ for new code)
- [ ] Artifacts: Clean commit-ready code
