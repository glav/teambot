...
- [x] `uv run pytest tests/test_notifications/test_templates.py -v` passes
- [x] Artifacts: New templates rendering correctly
...
- [x] **Task 2.1**: Emit orchestration_started event at run() entry
  - File: `src/teambot/orchestration/execution_loop.py`
  - Details: Lines 92-115
  - Emit after `time_manager.start()` (around Line 151)

- [x] **Task 2.2**: Emit orchestration_completed event at run() exit
  - File: `src/teambot/orchestration/execution_loop.py`
...
- [x] Artifacts: Events emitted with correct data
...
- [x] **Task 3.1**: Add config parameter to SystemCommands
...
- [x] Artifacts: /notify command functional
...
- [x] **Task 4.2**: Lint and format code
