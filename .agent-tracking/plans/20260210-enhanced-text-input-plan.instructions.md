...
- [x] **T1.1**: Write `Submitted` message API contract tests — [Details Lines 10-33](../details/20260210-enhanced-text-input-details.md)
...
- [x] **T1.2**: Write Enter-to-submit tests — [Details Lines 35-101](../details/20260210-enhanced-text-input-details.md)
  - File: `tests/test_ui/test_input_pane.py`
...
- [x] **T1.3**: Write Ctrl+Enter / Alt+Enter newline tests — [Details Lines 103-149](../details/20260210-enhanced-text-input-details.md)
  - File: `tests/test_ui/test_input_pane.py`
  - Tests: `test_ctrl_enter_inserts_newline`, `test_alt_enter_inserts_newline`
  - Verifies newline is inserted without submission

- [x] **T1.4**: Write conditional history navigation tests — [Details Lines 151-233](../details/20260210-enhanced-text-input-details.md)
  - File: `tests/test_ui/test_input_pane.py`
...
- [x] All TDD tests written in `tests/test_ui/test_input_pane.py`
- [x] Tests reference `InputPane.Submitted`, `.text`, and conditional cursor behavior
- [x] Tests PASS (widget migrated in parallel)
- [x] Artifacts: Updated `tests/test_ui/test_input_pane.py` with new test class `TestMultiLineInput`
...
- [x] **T2.1**: Migrate `InputPane` base class from `Input` to `TextArea` — [Details Lines 235-297](../details/20260210-enhanced-text-input-details.md)
...
- [x] **T2.2**: Implement custom `Submitted` message — [Details Lines 299-334](../details/20260210-enhanced-text-input-details.md)
  - File: `src/teambot/ui/widgets/input_pane.py`
...
- [x] **T2.3**: Implement `_on_key` handler — [Details Lines 336-403](../details/20260210-enhanced-text-input-details.md)
  - File: `src/teambot/ui/widgets/input_pane.py`
...
- [x] **T2.4**: Migrate `_navigate_history` to use `.text` — [Details Lines 405-430](../details/20260210-enhanced-text-input-details.md)
  - File: `src/teambot/ui/widgets/input_pane.py`
  - Replace all `self.value` with `self.text`

### Phase Gate: Phase 2 Complete When
- [x] All Phase 1 TDD tests pass
- [x] `InputPane` extends `TextArea` with custom `Submitted` message
- [x] `_on_key` correctly handles Enter, Ctrl+Enter, Alt+Enter, conditional Up/Down
- [x] Validation: `uv run pytest tests/test_ui/test_input_pane.py -v`
- [x] Artifacts: Updated `src/teambot/ui/widgets/input_pane.py`
...
- [x] **T3.1**: Update CSS for taller input — [Details Lines 432-468](../details/20260210-enhanced-text-input-details.md)
  - File: `src/teambot/ui/styles.css`
  - Add `height: 5; min-height: 3; max-height: 10;` to `#prompt`

- [x] **T3.2**: Verify `app.py` compatibility — [Details Lines 470-495](../details/20260210-enhanced-text-input-details.md)
...
- [x] CSS updated with height properties
- [x] App handler verified compatible (no changes needed)
- [x] Validation: `uv run pytest tests/test_ui/test_app.py -v`
- [x] Artifacts: Updated `src/teambot/ui/styles.css`
...
- [x] **T4.1**: Update existing tests `.value` → `.text` — [Details Lines 497-521](../details/20260210-enhanced-text-input-details.md)
...
- [x] **T4.2**: Add multi-line submission integration test — [Details Lines 523-562](../details/20260210-enhanced-text-input-details.md)
  - File: `tests/test_ui/test_input_pane.py`
  - Test: `test_multiline_content_submitted_intact`
  - Use Ctrl+Enter to build multi-line input, then Enter to submit; verify `\n` in submitted value

- [x] **T4.3**: Add multi-line history recall test — [Details Lines 564-608](../details/20260210-enhanced-text-input-details.md)
  - File: `tests/test_ui/test_input_pane.py`
...
- [x] All existing 4 history tests pass with `.text` assertions
- [x] `test_input_cleared_after_submit` passes with `.text` assertion
- [x] New multi-line tests pass
- [x] Validation: `uv run pytest tests/test_ui/ -v`
- [x] Artifacts: Updated test files
...
- [x] **T5.1**: Full test suite + lint — [Details Lines 610-641](../details/20260210-enhanced-text-input-details.md)
  - Run: `uv run pytest` (all ~1084 tests)
  - Run: `uv run ruff check .` and `uv run ruff format .`
  - Zero failures, zero lint errors

- [x] **T5.2**: Manual visual check (automated tests confirm layout and behavior) — [Details Lines 643-671](../details/20260210-enhanced-text-input-details.md)
...
- [x] `uv run pytest` passes all 1148 tests
- [x] `uv run ruff check .` passes
- [x] `uv run ruff format --check .` passes
- [x] Artifacts: None (verification only)
