...
- [ ] All new test classes created in `tests/test_repl/test_parser.py`
- [ ] 10+ new test functions covering UT-001 through UT-010
- [ ] All new tests fail when run (confirms bug detection)
- [ ] Validation: `uv run pytest tests/test_repl/test_parser.py::TestQuoteAwareHelpers -v` shows failures
- [ ] Artifacts: New test code in test_parser.py
...
- [ ] Validation: `uv run pytest tests/test_repl/test_parser.py::TestQuoteAwareHelpers -v` passes
- [ ] Artifacts: Helper functions in parser.py
...
- [ ] All parser functions updated
- [ ] Quoted pipeline tests pass
- [ ] Validation: `uv run pytest tests/test_repl/test_parser.py::TestQuotedPipelineHandling -v` passes
- [ ] Artifacts: Modified parser.py functions
...
- [ ] All 73+ existing parser tests pass
- [ ] All extended parser tests pass
- [ ] Coverage >= 95% for parser module
- [ ] Validation: `uv run pytest tests/test_repl/ --cov=src/teambot/repl/parser --cov-report=term-missing`
- [ ] Artifacts: Test results showing 100% pass rate
