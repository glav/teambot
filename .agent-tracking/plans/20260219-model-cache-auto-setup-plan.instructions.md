...
- [x] All unit tests created in tests/test_cli.py
- [x] Tests fail as expected (no implementation yet)
- [x] Validation: `uv run pytest tests/test_cli.py -k "TestRunAuth or TestRunModelCache" -v` shows failures
...
* [x] Task 2.3: Integrate auth check and cache ensure into `cmd_run()`
...
- [x] `_check_copilot_authentication_blocking()` implemented
- [x] `_ensure_model_cache()` implemented
- [x] `cmd_run()` calls both functions before config loading
- [x] Validation: `uv run pytest tests/test_cli.py -k "TestRunAuth or TestRunModelCache" -v` all pass
...
* [x] Task 3.1: Create acceptance test file with AT-001 to AT-005 scenarios
...
- [x] tests/test_model_cache_auto_acceptance.py created
- [x] All 8 acceptance scenarios implemented (AT-001 through AT-005, including sub-scenarios)
- [x] Validation: `uv run pytest tests/test_model_cache_auto_acceptance.py -v` all pass
- [x] Artifacts: New test file
